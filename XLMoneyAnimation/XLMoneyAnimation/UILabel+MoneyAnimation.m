...
- (void)xl_setNumber:(NSNumber *)number {
    [self xl_setNumber:number duration:1.0];
}

- (void)xl_setNumber:(NSNumber *)number duration:(NSTimeInterval)duration {
...
- (void)changeAnimation:(NSTimer *)timer{
    ...
    if (value == 0) {
        ...
        self.text = [NSString stringWithFormat:@"%.f",[formatter stringFromNumber:@(value)]];
    }
}
